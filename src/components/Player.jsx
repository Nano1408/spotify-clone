...
export const VolumeDown = () => (
    <svg fill="currentColor" role="presentation" width="16" height="16" aria-label="Volumen apagado" aria-hidden="true" viewBox="0 0 16 16">
...
export const VolumeUp = () => (
    <svg fill="currentColor" role="presentation" width="16" height="16" aria-label="Volumen alto" aria-hidden="true" viewBox="0 0 16 16">
...
const SongControl = ({audio}) => {
    ...
    <div className="flex gap-x-3 text-xs pt-2">
        ...
        {duration ? <span className="opacity-50 w-12">{formaTime(duration)}</span> : <span className="opacity-50 w-12">0:00</span>}
    </div>
    )
}
    ...
    return (
        <div className="flex justify-center gap-x-2 text-white">
            <button className="opacity-70 hover:opacity-100 transition" onClick={handleClickVolume}>
                {isVolumeSilenced ? <VolumeDown /> : <VolumeUp />}
            </button>
